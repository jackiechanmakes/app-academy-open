/*
 * Write a function isPerfectSquare that accepts a number as an
 * argument. The method should return a boolean indicating whether
 * or not the argument is a perfect square. A perfect square is a
